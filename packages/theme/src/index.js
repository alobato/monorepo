...
const reset = {
  ...
  '*': {
    ...
    WebkitTapHighlightColor: 'rgba(0, 0, 0, 0)' // * { -webkit-tap-highlight-color: rgba(0, 0, 0, 0); }
  },
  '*::before': {
    boxSizing: 'border-box'
  },
...
const theme = {
  ...
  text: {
    neon: {
      ...
      fontWeight: 'heading',
      fontSize: 4,
      // backgroundImage: 'linear-gradient(90deg,rgba(89,156,255,.15) 0,rgba(207,0,240,.15) 100%),linear-gradient(90deg,#51add0 0,#3e94fb 25.63%,#5f7bf6 49.48%,#984eef 78.6%,#cb2be4 99.57%)',
